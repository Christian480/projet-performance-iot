...
from visuel import load_runs, plot_timeline, plot_distribution
from statistique import profiling_par_block, top3_blocs_lents, taux_succes, temps_moyen_total, plot_hotspots
